        ...
        if ($totalBalanceAmount === null) {
            ...
            if ($percentage < $lowExpenses) {
                ...
                if ($locale === 'id') {
                    ...
                    $message = 'Pengeluaran Anda sudah mulai meningkat. Saatnya mulai mengelola keuangan dengan lebih cermat.';
                    $icon = 'warning';
                } else {
                    $statusOutcome = 'Medium Spending';
                    $title = 'Moderate Spending';
                    $message = 'Your spending has started to increase. Time to start managing your finances more carefully.';
                    $icon = 'warning';
                }
            } else {
                if ($locale === 'id') {
                    ...
                    $title = 'Peringatan!';
                    $message = 'Pengeluaran Anda sudah di luar batas normal. Cari solusi untuk mengurangi pengeluaran yang tidak perlu.';
                    $icon = 'error';
                } else {
                    $statusOutcome = 'High Spending';
                    $title = 'Caution!';
                    $message = 'Your spending is beyond normal limits. Find solutions to reduce unnecessary spending.';
                    $icon = 'error';
                }
            }

            session([
                'statusOutcome.title' => $title,
                'statusOutcome.message' => $message,
                'statusOutcome.icon' => $icon
            ]);
        }
