...
Route::get('/income-table', [BalanceController::class, 'showIncomePage'])->name('openIncomePage')->middleware('checkLogin');
Route::get('/outflow-table', [BalanceController::class, 'showOutcomePage'])->name('openOutcomePage')->middleware('checkLogin');
